  ...
  return (
    <header className="relative z-40 bg-[#FFFDF6] px-4 pt-6 pb-3.5">
      <div className="container flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center gap-2 font-['Outfit'] font-black text-base lg:text-lg text-[#121212]">
          <button
        ...
        <div className="flex items-center gap-2.5">
          ...
          <button
            onClick={toggleSound}
            className="w-11 h-11 bg-[#A594F9] text-[#121212] border-[2.5px] border-[#121212] rounded-xl flex items-center justify-center shadow-[2.5px_2.5px_0px_#121212] hover:translate-y-[-1px] hover:shadow-[3.5px_3.5px_0px_#121212] active:translate-y-[1px] active:shadow-[1px_1px_0px_#121212] transition-all"
          ...
          <button
            ...
            className="w-11 h-11 bg-[#FFDE59] text-[#121212] border-[2.5px] border-[#121212] rounded-xl flex lg:hidden items-center justify-center shadow-[2.5px_2.5px_0px_#121212] active:translate-y-[1px]"
          >
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden mt-3 p-4 bg-[#FFFDF6] border-[3px] border-[#121212] rounded-2xl shadow-[5px_5px_0px_#121212] space-y-3 animate-float">
          ...
          <button
            ...
            className="w-full neo-btn-primary py-3.5 font-black text-base text-center border-[2.5px] border-[#121212] rounded-xl flex items-center justify-center"
          >
